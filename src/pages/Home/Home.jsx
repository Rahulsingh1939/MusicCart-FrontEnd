  ...
  return (
    <div className={HomeCSS.element}>
      <div className={HomeCSS.div}>
        <div className={HomeCSS.overlap}>
          <div className={HomeCSS.group}>
            <p className={HomeCSS["text-wrapper"]}>Get 50% off on selected items</p>
            <div className={HomeCSS["text-wrapper-2"]}>Shop Now</div>
            <img className={HomeCSS.line} alt="Line" src="https://c.animaapp.com/aUDSW2NR/img/line-1.svg" />
          </div>
          <img
            className={HomeCSS["ph-phone-call-light"]}
            alt="Ph phone call light"
            src="https://c.animaapp.com/aUDSW2NR/img/ph-phone-call-light.svg"
          />
          <div className={HomeCSS["text-wrapper-3"]}>912121131313</div>
          <div className={HomeCSS["text-wrapper-4"]}>Login</div>
          <div className={HomeCSS["text-wrapper-5"]}>Signup</div>
          <img className={HomeCSS.img} alt="Line" src="https://c.animaapp.com/aUDSW2NR/img/line-12.svg" />
        </div>
        <div className={HomeCSS["overlap-group"]}>
          <p className={HomeCSS.p}>Musicart | All rights reserved</p>
        </div>
